...
# pip install openai
# Usage:  python print_References-2024.py
...
# or provide the  API key string explicitly 
...
# This prompt is requesting 10 journal publications published in 2024, which are new and not available to GPT model yet.
# Therefore, the model will simply hallucinate them, they are all not real. Therefore, the entropy will be high.
#
system_prompt= """
You are a university professor specializing in Quantum Information Theory.  You have written a journal paper entitled "Quantum Data Compression". Now create a References section which includes 10 journal publications suitable for the paper and published in 2024.
"""
